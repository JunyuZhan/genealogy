...
### 7.1 祭扫入口与展示
- [ ] 7.1.1 成员详情页祭扫入口（已故成员右上角"祭扫"按钮）
- [ ] 7.1.2 祭扫纪念独立页面（可选择成员）
- [ ] 7.1.3 祭扫地图（在地图上直接点击墓冢祭扫）
- [ ] 7.1.4 祭扫虚拟场景展示（祠堂/墓地背景、祖先遗像）

### 7.2 祭扫交互与动画
- [ ] 7.2.1 献花：虚拟花束递送动画 + 音效
- [ ] 7.2.2 点烛：蜡烛点燃闪烁动画 + 背景音乐（可选）
- [ ] 7.2.3 上香：香烟袅袅上升动画
- [ ] 7.2.4 留言：文字输入，显示在纪念墙
- [ ] 7.2.5 祭扫特效：花瓣飘落、烛光摇跃、烟雾上升

### 7.3 祭扫记录与统计
- [ ] 7.3.1 祭扫日志记录（谁、何时、做了什么）
- [ ] 7.3.2 祭扫统计展示（祭扫人数、最后祭扫时间）
- [ ] 7.3.3 纪念墙展示（匿名显示留言）
- [ ] 7.3.4 在线状态显示（"XX人正在祭扫"）
